...
//   const removeSkill = (index: number) => setFormData({
//     ...formData,
...
//   const removeExperience = (index: number) => setFormData({
//     ...formData,
...
//   const addEducation = () => setFormData({ ...formData, educationList: [...formData.educationList, ''] });
//   const removeEducation = (index: number) => setFormData({
//     ...formData,
//     educationList: formData.educationList.filter((_, i) => i !== index),
//   });
