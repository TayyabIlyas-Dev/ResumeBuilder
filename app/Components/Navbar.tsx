...
const Navbar: React.FC<navprops> = ({ logo }) => {
  return (
    <div className="flex justify-center">
      <nav
        className="fixed top-0 px-2 w-[90vw] z-50 bg-white bg-opacity-30 backdrop-blur-lg shadow-md mt-5 border border-[#e4e4e7] rounded-full"
        aria-label="Main Navigation"
      >
        <div className="container mx-auto px-4 py-2.5 sm:py-3 flex justify-between items-center">
          {/* Logo */}
          <div className="flex items-center">
            <span className="text-2xl font-extrabold flex justify-center items-center text-black">
              <Link href="/" aria-label="Home" className="flex items-center gap-1">
                <span className="text-blue-600 text-3xl"><PiReadCvLogoDuotone/></span>
                {logo}
              </Link>
            </span>
          </div>
